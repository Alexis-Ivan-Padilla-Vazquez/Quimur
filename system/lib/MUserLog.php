...
//USER LOG FUNCTIONS
	...
	function MUserLog_SendEmailBienvenida($user){
		$content = 'Bienvenido a Sevilla Fusion, gracias por registrarse en nuestro sistema.<br /> Apartir de este momento ud. puede revisar 
		sus cotizaciones con los siguientes accesos:<br /><br />
		Link de Acceso: <a href="'. ABS_HTTP_URL .'user.php">'. ABS_HTTP_URL .'user.php</a><br /><br />
		usuario: '.$user['email'].'<br />
		contraseña: '.$user['password'].'
		';
		lib_sendEmail($user['email'],'Bienvenido a Sevilla Fusion',$content);
	}
