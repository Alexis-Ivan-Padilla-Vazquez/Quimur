...
$args['controller_file'] = 'Usuario.php';

$args['view_dir'] = 'Usuario/';
$args['view_file'] = '';

$args['table_name_list'] = 'usuario';
$args['table_name'] = 'usuario';
$args['table_id'] = 'id';
...
$args['cmd_show'] = 'usuarios';
$args['seccion_title'] = 'Usuario';
...
switch( $cmd ){
	case 'save':
		...
		if( !empty($_FILES['imagen']['name']) ){
			...
			$result = uploadFile( 'imagen', getImgDir('usuario','imagen',0,0,false) . $img_name ,$tiposValidos );
