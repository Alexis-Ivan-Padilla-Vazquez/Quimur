...
$config['renameColumns'] = array('id' =>'ID','titulo' =>'Titulo','imagen'=>'Imagen','fecha'=>'Fecha','hora'=>'Hora','categoria_id'=>'Categoria','user_id'=>'Usuario'); 
$config['hiddenColumns'] = array('subtitulo','contenido','video','tags','publicado'); 

$header_title = 'Blogs';

if( $_REQUEST['msj'] == 1 ){
	$header_msj_class = 'ok msj';
	$header_msj = 'Registro Blog Guardado';
}
if( $_REQUEST['msj'] == 2 ){
	$header_msj_class = 'ok msj';
	$header_msj = 'Registro Blog Eliminado';
}
?>
