...
<h2 style="margin-top:30px; float:right;padding-right:170px;">Orden de Cotizacion No. <?php echo $order['m_cart_order_id']; ?></h2>
...
"<BR /><strong>Peso: ".number_format($item['peso_grs'],2,'.',',')." grs.</strong>" : "" ).'</td></td>
								<td>'.$item['cantidad'].'</td>
...
<span style="font-family:Arial, Helvetica, sans-serif; font-size:12px;">
<br /><br />
Comentarios del cotizacion:<br />  <?php echo empty($order['comentarios']) ? '<em>No hay comentarios encontrados</em>' : $order['comentarios']; ?>
</span>
<br /><br /><br />
              </div>
