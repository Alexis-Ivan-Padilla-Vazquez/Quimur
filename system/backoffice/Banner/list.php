...
$config['renameColumns'] = array('id' =>'ID','titulo' =>'Titulo','subtitulo' =>'Subtítulo','imagen'=>'Imagen','fecha'=>'Fecha','hora'=>'Hora','categoria_id'=>'Categoria','user_id'=>'Usuario','encabezado'=>'Ecabezado'); 
$config['hiddenColumns'] = array('imagen','url'); 

$header_title = 'Banners';

if( $_REQUEST['msj'] == 1 ){
	$header_msj_class = 'ok msj';
	$header_msj = 'Registro Banner Guardado';
}
if( $_REQUEST['msj'] == 2 ){
	$header_msj_class = 'ok msj';
	$header_msj = 'Registro Banner Eliminado';
}
?>
