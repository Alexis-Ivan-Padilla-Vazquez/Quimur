...
$args['controller_file'] = 'Marca.php';

$args['view_dir'] = 'Marca/';
$args['view_file'] = '';

$args['table_name_list'] = 'marca';
$args['table_name'] = 'marca';
$args['table_id'] = 'id';
...
$args['cmd_show'] = 'marcas';
$args['seccion_title'] = 'Marca';
...
switch( $cmd ){
	case 'save':
		...
		if( !empty($_FILES['imagen']['name']) ){
			...
			$result = uploadFile( 'imagen', getImgDir('marca','imagen',0,0,false) . $img_name ,$tiposValidos );
