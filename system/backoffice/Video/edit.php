...
$form = array();
$form['title'] = 'Informacion de Video';
$items = array();
...
$items[] = array('text'=>'Link', 'type'=>'text', 'name'=>'entity[url]', 'value'=> $data['url'], id =>'url', 'class' => 'col-md-6');
...
$form['items'] = $items;
$header_title = $cmd == 'add' ? 'Agregar Video' :  'Editar Video';
echo '<div class="row">
