...
$args['controller_file'] = 'Banner.php';

$args['view_dir'] = 'Banner/';
$args['view_file'] = '';

$args['table_name_list'] = 'banner';
$args['table_name'] = 'banner';
$args['table_id'] = 'id';
...
$args['cmd_show'] = 'banners';
$args['seccion_title'] = 'Banner';
...
switch( $cmd ){
	case 'save':
		...
		if( !empty($_FILES['imagen']['name']) ){
			...
			$result = uploadFile( 'imagen', getImgDir('banner','imagen',0,0,false) . $img_name ,$tiposValidos );
