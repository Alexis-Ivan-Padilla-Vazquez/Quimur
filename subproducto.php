						...
						if (!$resultado5) {
							...
							echo "Error MySQL: " . mysql_error();    
										...
										while ($fila5 = mysql_fetch_assoc($resultado5)) {
															  $imagen = $fila5['imagen'];
														      $nombre = utf8_encode($fila5['nombre']);
																}
																	...
																	$resultado6 = mysql_query($sql6, $enlace);
																		if (!$resultado6) {
																			...
																			echo "Error MySQL: " . mysql_error();    
																						...
																						$descripcion2 = utf8_encode($fila6['descripcion']);
																						$id_producto = $fila6['id'];

																						$nom_producto = utf8_encode($fila6['producto']);
																										}
		...
		<div class="row">
			...
			<div class="banner-title-content">
				<div class="container">
		        	<ul class="breadcrumb">
			            <li>Productos</li>
			            <li><a href="productos.php?producto=<?php echo base64_encode($nombre)?>"><? echo $nombre; ?></a></li>

			          <li><a href="#"><? echo $nom_producto; ?></a></li>
		          	</ul>
	          	</div>
